...
module.exports = function(options) {
    ...
    return function(req, res, next) {
        ...
        var ruler = parser && parser.match(req.url);
        ...
        if (ruler) {
            ...
            switch (ruler.type) {
                ...
                default:
                    ...
                    res.setHeader('Location', ruler.to)
                    res.end('Redirecting to <a href="' + escapeHtml(ruler.to) + '">' + escapeHtml(ruler.to) + '</a>\n')
                    return;
            }
        }
